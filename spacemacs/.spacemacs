...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(color-theme-solarized mic-paren)
   ;; A list of packages that cannot be updated.
   dotspacemacs-frozen-packages '(color-theme-solarized)
   ;; A list of packages that will not be installed and loaded.
   dotspacemacs-excluded-packages '(highlight-parentheses smartparens)
...
`dotspacemacs/user-config' first."
  (setq ycmd-server-command '("python3" "/Users/kderonne/YouCompleteMe/third_party/ycmd/ycmd"))
)
...
(setq org-agenda-files '("~/notes/done.org" "~/notes/"))
;;                         "~/gtd/gtd.org"
;;                         "~/gtd/tickler.org"))
...
(custom-set-faces
 ...
 '(org-todo ((t (:background "brightblack" :foreground "brightred" :weight bold))))
