    ...
    (let ((bg-back   '(:background back))
      ...
      (mapcar (lambda (face) (apply 'create-face-spec face))
              `(;; basic
                ...
                ;; these seems to just turn off colors for the usually highlighted pdb import line
                (hi-yellow (@fg-magenta))
                ;; info
                ...
                ;; KDR's  meddling
                ;;(flx-highlight-face (@fg-magenta))
                ;;(spacemacs-ido-navigation-ms-face (@fg-base0))
                ;;(spacemacs-micro-state-header-face (@fg-base0))
                ;;(cursor (@fg-magenta))
                ;; markdown
                ...
                (sp-show-pair-match-face (,@fg-magenta ,@bg-base02))
